...
if($_POST!='' && isset($_POST)){
	...
	if($_REQUEST['InputEmail']!='' || $_REQUEST['InputName']!='' || $_REQUEST['InputWeb']!='' || $_REQUEST['InputMessage']!='')
	{
		$to = "Dominique1115@yahoo.com"; 
		$from = strip_tags($_REQUEST['InputEmail']); 
		$name = strip_tags($_REQUEST['InputName']);
		$website = strip_tags($_REQUEST['InputWeb']); 
